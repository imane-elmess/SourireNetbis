...
public class TablePanelPatient extends JPanel {
    MyTableModelPatient tableModel;
    JScrollPane tableScrollPane; //pour ajouter la ligne pour monter et descendre
    JTable table;//utilise un modèle de données


    //getters
    public MyTableModelPatient getTableModel() {
        return tableModel;
    }
    ...
    private void initComponents(String ... columns) {
        ...
        tableModel = new MyTableModelPatient(columns); //les columns seront données dans le frame pour etre utilisées
    ...
    public TablePanelPatient(String ... columns){
